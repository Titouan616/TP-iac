terraform {
  ...
  # Phase 2 - Remote backend Azure Blob Storage
  # Décommenter après avoir créé le storage account :
  #   az storage account create --name tfstateiac --resource-group RG-WBER-EUW --location westeurope --sku Standard_LRS
  #   az storage container create --name tfstate --account-name tfstateiac
  #
  # backend "azurerm" {
  #   resource_group_name  = "RG-WBER-EUW"
  #   storage_account_name = "tfstateiac"
